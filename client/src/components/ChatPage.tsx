...
        ? `http://localhost:4000/api/chats/${chatRoomId}/messages/${messageToDelete.id}/audio`
        : `http://localhost:4000/api/chats/${chatRoomId}/messages/${messageToDelete.id}`;
...
    try {
      const token = localStorage.getItem("token");
      await axios.delete(`http://localhost:4000/api/chats/${chatRoomId}/messages/all`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      
      setMessages([]); 
...
      const res = await axios.post(
        `http://localhost:4000/api/chats/${chatRoomId}/audio`,
        formData,
        {
          headers: {
